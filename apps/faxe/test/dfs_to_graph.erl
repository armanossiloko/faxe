...
bridge_test() ->
  ...
  [{<<"amqp_publish5">>,esp_amqp_publish,
    #{port => undefined,exchange => <<"x_root_fanout">>,
      ...
      qos => 0,'_name' => <<"amqp_publish5">>,
      routing_key => <<"some.crazy.topic.this.is">>,
      vhost_prefix => <<"undefined">>,
      '_stop_idle' => false,
    ...
    {<<"mqtt_subscribe1">>,esp_mqtt_subscribe,
      #{port => 1883,version => <<"v5">>,
        user => <<"undefined">>,ssl => false,
        host => <<"10.102.1.102">>,pass => <<"undefined">>,
        as => undefined,qos => 1,
        '_name' => <<"mqtt_subscribe1">>,
        include_topic => true,
        dt_format => <<"millisecond">>,
        dt_field => <<"ts">>,topic_as => <<"topic">>,
        '_stop_idle' => false,
        topic => <<"some/crazy/topic/this/is">>,
        client_id => undefined,topics => undefined,
        '_idle_time' => <<"5m">>,
        '_stop_when' => undefined}}],
    edges =>

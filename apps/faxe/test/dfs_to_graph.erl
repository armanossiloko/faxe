    ...
    [{<<"amqp_publish5">>,esp_amqp_publish,
      ...
      {<<"mqtt_subscribe1">>,esp_mqtt_subscribe,
        #{'_idle_time' => <<"5m">>,
          ...
          '_stop_idle' => false,'_stop_when' => undefined,
          as => undefined,client_id => undefined,
          dt_field => <<"ts">>,
